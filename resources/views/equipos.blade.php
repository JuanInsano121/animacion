...
<body>
    ...
    @endif
        ...
        <!-- Formulario para ingresar datos de equipos -->
        <form action="{{ url('/equipos') }}" method="post">
            ...
            <div class="form-group">
                <label for="MARCA_MOD">Marca/Modelo:</label>
                <input type="text" name="MARCA_MOD" required><br>
            </div>

            <div class="form-group">
                <label for="DESCRIPCION_EQUIPO">Descripción del Equipo:</label>
                <textarea name="DESCRIPCION_EQUIPO" rows="4" required></textarea><br>
            </div>
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js"
        integrity="sha384-Ch4P+JMEg5lYR5VjLh3Q1jF5IrZxm9+Sq0Y9J1aDhJ3gEFUO1ePqFmiFF2A02bOt" crossorigin="anonymous">
    </script>
    <div>
        <div>
