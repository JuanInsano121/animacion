...
@endif
    <!-- Formulario para ingresar datos de estudiantes -->
    <form action="{{ url('/estudiantes') }}" method="post">
        @csrf

        <div class="form-group">
        <label for="ID_ESTUDIANTES">ID Estudiante:</label>
        <input type="text" name="ID_ESTUDIANTES" required><br>
        </div>

        <div class="form-group">
        <label for="NOMBRE_EST">Nombre:</label>
        <input type="text" name="NOMBRE_EST" required><br>
        </div>

        <div class="form-group">
        <label for="AP_P_EST">Apellido Paterno:</label>
        <input type="text" name="AP_P_EST" required><br>
        </div>

        <div class="form-group">
        <label for="AP_M_EST">Apellido Materno:</label>
        <input type="text" name="AP_M_EST" required><br>
        </div>

        <div class="form-group">
        <label for="CORREO_INSTITUCIONAL">Correo Institucional:</label>
        <input type="email" name="CORREO_INSTITUCIONAL" required><br>
        </div>

        <div class="form-group">
        <label for="NO_CONTROL">Número de Control:</label>
        <input type="text" name="NO_CONTROL" required><br>
        </div>
